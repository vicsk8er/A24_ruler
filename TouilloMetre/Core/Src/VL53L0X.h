...
class VL53L0X {
private:
	static const uint8_t VL53L0X_ADDR = 0x52;
...
public:
	...
	VL53L0X(uint8_t addr, I2CHandler& i2cHandler);
	//------------------------------------------------------------
	// API Functions
	//------------------------------------------------------------
	...
	uint8_t initVL53L0X(bool io_2v8);
	...
	// factor of N decreases the range meHTU21Dasurement standard deviation by a factor of
	...
	//---------------------------------------------------------
	bool writeReg(uint8_t reg, uint8_t value);        // Write an 8-bit register
	bool writeReg16Bit(uint8_t reg, uint16_t value);  // Write a 16-bit register
	bool writeReg32Bit(uint8_t reg, uint32_t value);  // Write a 32-bit register
